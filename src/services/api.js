...
export const notesAPI = {
  getAll: (subjectId) => api.get('/notes', { params: { subject_id: subjectId } }),
...
export const studyLogsAPI = {
  ...
  create: (subjectId, hoursStudied, notes = '') =>
    api.post('/study-logs', { subject_id: subjectId, hours_studied: hoursStudied, notes }),
  getTotalHours: (subjectId) =>
    api.get('/study-logs/total', { params: subjectId ? { subject_id: subjectId } : {} }),
